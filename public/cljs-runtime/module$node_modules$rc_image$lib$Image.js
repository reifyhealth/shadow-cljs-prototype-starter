...
registerImage=onPreviewVisibleChange.registerImage;onPreviewVisibleChange=React.useState(function(){return uuid+=1});var currentId=(0,_slicedToArray2.default)(onPreviewVisibleChange,1)[0],canPreview=_ref$preview&&!isError,isLoaded=React.useRef(!1),onLoad=function(){setStatus("normal")};onPreviewVisibleChange=function(e){onImageError&&onImageError(e);setStatus("error")};var onPreview=function(e){if(!isControlled){var _getOffset=(0,_css.getOffset)(e.target),left=_getOffset.left;_getOffset=_getOffset.top;
isPreviewGroup?(setCurrent(currentId),setGroupMousePosition({x:left,y:_getOffset})):setMousePosition({x:left,y:_getOffset})}isPreviewGroup?setGroupShowPreview(!0):setShowPreview(!0);onClick&&onClick(e)},onPreviewClose=function(e){e.stopPropagation();setShowPreview(!1);isControlled||setMousePosition(null)};React.useEffect(function(){return registerImage(currentId,src)},[]);React.useEffect(function(){registerImage(currentId,src,canPreview)},[src,canPreview]);React.useEffect(function(){isError&&setStatus("normal");
isCustomPlaceholder&&!isLoaded.current&&setStatus("loading")},[imgSrc]);wrapperClassName=(0,_classnames.default)(_ref$prefixCls,wrapperClassName,(0,_defineProperty2.default)({},"".concat(_ref$prefixCls,"-error"),isError));var mergedSrc=isError&&fallback?fallback:src;style={crossOrigin:crossOrigin,decoding:decoding,loading:loading,referrerPolicy:referrerPolicy,sizes:sizes,srcSet:srcSet,useMap:useMap,alt:alt,className:(0,_classnames.default)("".concat(_ref$prefixCls,"-img"),(0,_defineProperty2.default)({},
"".concat(_ref$prefixCls,"-img-placeholder"),!0===placeholder),className),style:(0,_objectSpread2.default)({height:height},style)};return React.createElement(React.Fragment,null,React.createElement("div",(0,_extends2.default)({},_ref,{className:wrapperClassName,onClick:_ref$preview&&!isError?onPreview:onClick,style:(0,_objectSpread2.default)({width:width,height:height},wrapperStyle)}),React.createElement("img",(0,_extends2.default)({},style,{ref:function(img){isLoaded.current=!1;"loading"===status&&
(null===img||void 0===img?0:img.complete)&&(img.naturalWidth||img.naturalHeight)&&(isLoaded.current=!0,onLoad())}},isError&&fallback?{src:fallback}:{onLoad:onLoad,onError:onPreviewVisibleChange,src:imgSrc})),"loading"===status&&React.createElement("div",{"aria-hidden":"true",className:"".concat(_ref$prefixCls,"-placeholder")},placeholder),_ref2$visible&&canPreview&&React.createElement("div",{className:(0,_classnames.default)("".concat(_ref$prefixCls,"-mask"),maskClassName)},_ref2$visible)),!isPreviewGroup&&
canPreview&&React.createElement(_Preview.default,(0,_extends2.default)({"aria-hidden":!previewSrc,visible:previewSrc,prefixCls:_ref$previewPrefixCls,onClose:onPreviewClose,mousePosition:previewVisible,src:mergedSrc,alt:alt,getContainer:onInitialPreviewClose,icons:icons},_ref2)))};require.PreviewGroup=_PreviewGroup.default;require.displayName="Image";exports.default=require}
