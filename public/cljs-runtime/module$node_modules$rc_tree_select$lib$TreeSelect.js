...
_inherits2=global(require("module$node_modules$$babel$runtime$helpers$inherits")),_createSuper2=global(require("module$node_modules$$babel$runtime$helpers$createSuper")),_toConsumableArray2=global(require("module$node_modules$$babel$runtime$helpers$toConsumableArray")),_typeof2=global(require("module$node_modules$$babel$runtime$helpers$typeof")),_slicedToArray2=global(require("module$node_modules$$babel$runtime$helpers$slicedToArray")),_objectSpread2=global(require("module$node_modules$$babel$runtime$helpers$objectSpread2")),
React=module(require("module$node_modules$react$index")),_generate=global(require("module$node_modules$rc_select$lib$generate")),_valueUtil=require("module$node_modules$rc_select$lib$utils$valueUtil"),_treeUtil=require("module$node_modules$rc_tree$lib$utils$treeUtil"),_conductUtil=require("module$node_modules$rc_tree$lib$utils$conductUtil"),_generator=require("module$node_modules$rc_select$lib$interface$generator"),_useMergedState3=global(require("module$node_modules$rc_util$lib$hooks$useMergedState")),
_warning=global(require("module$node_modules$rc_util$lib$warning")),_OptionList=global(require("module$node_modules$rc_tree_select$lib$OptionList"));module=global(require("module$node_modules$rc_tree_select$lib$TreeNode"));var _valueUtil2=require("module$node_modules$rc_tree_select$lib$utils$valueUtil"),_warningPropsUtil=global(require("module$node_modules$rc_tree_select$lib$utils$warningPropsUtil")),_Context=require("module$node_modules$rc_tree_select$lib$Context"),_useTreeData=global(require("module$node_modules$rc_tree_select$lib$hooks$useTreeData")),
_useKeyValueMap3=global(require("module$node_modules$rc_tree_select$lib$hooks$useKeyValueMap")),_useKeyValueMapping3=global(require("module$node_modules$rc_tree_select$lib$hooks$useKeyValueMapping")),_strategyUtil=require("module$node_modules$rc_tree_select$lib$utils$strategyUtil"),_legacyUtil=require("module$node_modules$rc_tree_select$lib$utils$legacyUtil"),_useSelectValues=global(require("module$node_modules$rc_tree_select$lib$hooks$useSelectValues")),OMIT_PROPS="expandedKeys treeData treeCheckable showCheckedStrategy searchPlaceholder treeLine treeIcon showTreeIcon switcherIcon treeNodeFilterProp filterTreeNode dropdownPopupAlign treeDefaultExpandAll treeCheckStrictly treeExpandedKeys treeLoadedKeys treeMotion onTreeExpand onTreeLoad loadData treeDataSimpleMode treeNodeLabelProp treeDefaultExpandedKeys".split(" "),
RefSelect=(0,_generate.default)({prefixCls:"rc-tree-select",components:{optionList:_OptionList.default},convertChildrenToData:function(){return null},flattenOptions:_valueUtil2.flattenOptions,getLabeledValue:_valueUtil.getLabeledValue,filterOptions:_valueUtil2.filterOptions,isValueDisabled:_valueUtil2.isValueDisabled,findValueOption:_valueUtil2.findValueOption,omitDOMProps:function(props){var cloneProps=(0,_objectSpread2.default)({},props);OMIT_PROPS.forEach(function(prop){delete cloneProps[prop]});
return cloneProps}});RefSelect.displayName="Select";var RefTreeSelect=React.forwardRef(function(props,ref){var treeCheckable=props.treeCheckable,treeCheckStrictly=props.treeCheckStrictly,_props$showCheckedStr=props.showCheckedStrategy,showCheckedStrategy=void 0===_props$showCheckedStr?"SHOW_CHILD":_props$showCheckedStr,labelInValue=props.labelInValue;_props$showCheckedStr=props.loadData;var treeLoadedKeys=props.treeLoadedKeys,_props$treeNodeFilter=props.treeNodeFilterProp;_props$treeNodeFilter=void 0===
_props$treeNodeFilter?"value":_props$treeNodeFilter;var treeNodeLabelProp=props.treeNodeLabelProp,treeDataSimpleMode=props.treeDataSimpleMode,treeData=props.treeData,treeExpandedKeys=props.treeExpandedKeys,treeDefaultExpandedKeys=props.treeDefaultExpandedKeys,treeDefaultExpandAll=props.treeDefaultExpandAll,children=props.children,treeIcon=props.treeIcon,showTreeIcon=props.showTreeIcon,switcherIcon=props.switcherIcon,treeLine=props.treeLine,treeMotion=props.treeMotion,filterTreeNode=props.filterTreeNode,
dropdownPopupAlign=props.dropdownPopupAlign,onChange=props.onChange,onTreeExpand=props.onTreeExpand,onTreeLoad=props.onTreeLoad,onDropdownVisibleChange=props.onDropdownVisibleChange,onSelect=props.onSelect,onDeselect=props.onDeselect,mergedCheckable=treeCheckable||treeCheckStrictly,mergedMultiple=props.multiple||mergedCheckable,treeConduction=treeCheckable&&!treeCheckStrictly,mergedLabelInValue=treeCheckStrictly||labelInValue,selectRef=React.useRef(null);React.useImperativeHandle(ref,function(){return{focus:selectRef.current.focus,
