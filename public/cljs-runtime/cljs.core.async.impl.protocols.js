...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26335 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_26335(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26337 = (function (port,val,fn1_handler){
var x__4428__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_26337(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26372 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_26372(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26373 = (function (chan){
var x__4428__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_26373(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26374 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_26374(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26375 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_26375(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_26377 = (function (h){
var x__4428__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_26377(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26381 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_26381(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26389 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_26389(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26396 = (function (b,itm){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_26396(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26406 = (function (b){
var x__4428__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_26406(b);
}
});
