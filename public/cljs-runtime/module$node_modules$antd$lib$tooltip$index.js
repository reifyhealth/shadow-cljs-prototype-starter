...
align){var placements=getTooltipPlacements(),placement=Object.keys(placements).filter(function(key){return placements[key].points[0]===align.points[0]&&placements[key].points[1]===align.points[1]})[0];if(placement){var rect=domNode.getBoundingClientRect(),JSCompiler_object_inline_top_1822="50%",JSCompiler_object_inline_left_1823="50%";if(0<=placement.indexOf("top")||0<=placement.indexOf("Bottom"))JSCompiler_object_inline_top_1822="".concat(rect.height-align.offset[1],"px");else if(0<=placement.indexOf("Top")||
0<=placement.indexOf("bottom"))JSCompiler_object_inline_top_1822="".concat(-align.offset[1],"px");if(0<=placement.indexOf("left")||0<=placement.indexOf("Right"))JSCompiler_object_inline_left_1823="".concat(rect.width-align.offset[0],"px");else if(0<=placement.indexOf("right")||0<=placement.indexOf("Left"))JSCompiler_object_inline_left_1823="".concat(-align.offset[0],"px");domNode.style.transformOrigin="".concat(JSCompiler_object_inline_left_1823," ").concat(JSCompiler_object_inline_top_1822)}},overlayInnerStyle:_classNames2,
