...
React.useContext(_TableContext.default),prefixCls=_React$useContext.prefixCls,scrollbarSize=_React$useContext.scrollbarSize,isSticky=_React$useContext.isSticky,combinationScrollBarSize=isSticky&&!fixHeader?0:scrollbarSize,scrollRef=React.useRef(null);fixHeader=React.useCallback(function(element){(0,_ref2.fillRef)(ref,element);(0,_ref2.fillRef)(scrollRef,element)},[]);React.useEffect(function(){function onWheel(e){var currentTarget=e.currentTarget,deltaX=e.deltaX;deltaX&&(onScroll({currentTarget:currentTarget,
scrollLeft:currentTarget.scrollLeft+deltaX}),e.preventDefault())}var _scrollRef$current;null===(_scrollRef$current=scrollRef.current)||void 0===_scrollRef$current?void 0:_scrollRef$current.addEventListener("wheel",onWheel);return function(){var _scrollRef$current2;null===(_scrollRef$current2=scrollRef.current)||void 0===_scrollRef$current2?void 0:_scrollRef$current2.removeEventListener("wheel",onWheel)}},[]);_React$useContext=React.useMemo(function(){return flattenColumns.every(function(column){return 0<=
column.width})},[flattenColumns]);scrollbarSize=flattenColumns[flattenColumns.length-1];var ScrollBarColumn={fixed:scrollbarSize?scrollbarSize.fixed:null,onHeaderCell:function(){return{className:"".concat(prefixCls,"-cell-scrollbar")}}};scrollbarSize=(0,React.useMemo)(function(){return combinationScrollBarSize?[].concat((0,_toConsumableArray2.default)(columns),[ScrollBarColumn]):columns},[combinationScrollBarSize,columns]);var flattenColumnsWithScrollbar=(0,React.useMemo)(function(){return combinationScrollBarSize?
[].concat((0,_toConsumableArray2.default)(flattenColumns),[ScrollBarColumn]):flattenColumns},[combinationScrollBarSize,flattenColumns]),headerStickyOffsets=(0,React.useMemo)(function(){var right=stickyOffsets.right,left=stickyOffsets.left;return(0,_objectSpread2.default)((0,_objectSpread2.default)({},stickyOffsets),{},{left:"rtl"===direction?[].concat((0,_toConsumableArray2.default)(left.map(function(width){return width+combinationScrollBarSize})),[0]):left,right:"rtl"===direction?right:[].concat((0,
_toConsumableArray2.default)(right.map(function(width){return width+combinationScrollBarSize})),[0]),isSticky:isSticky})},[combinationScrollBarSize,stickyOffsets,isSticky]);colWidths=useColumnWidth(colWidths,columCount);return React.createElement("div",{style:(0,_objectSpread2.default)({overflow:"hidden"},isSticky?{top:offsetHeader}:{}),ref:fixHeader,className:(0,_classnames.default)("".concat(prefixCls,"-header"),(0,_defineProperty2.default)({},stickyClassName,!!stickyClassName))},React.createElement("table",
{style:{tableLayout:"fixed",visibility:noData||colWidths?null:"hidden"}},(!noData||!maxContentScroll||_React$useContext)&&React.createElement(_ColGroup.default,{colWidths:colWidths?[].concat((0,_toConsumableArray2.default)(colWidths),[combinationScrollBarSize]):[],columCount:columCount+1,columns:flattenColumnsWithScrollbar}),React.createElement(_Header.default,(0,_extends2.default)({},_ref,{stickyOffsets:headerStickyOffsets,columns:scrollbarSize,flattenColumns:flattenColumnsWithScrollbar}))))});require.displayName=
"FixedHeader";exports.default=require}
