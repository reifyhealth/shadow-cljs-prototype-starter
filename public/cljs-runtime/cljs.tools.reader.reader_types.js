...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_25799 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_25799(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_25800 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_25800(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25802 = (function (reader,ch){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_25802(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25803 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_25803(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25809 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_25809(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25814 = (function (reader){
var x__4463__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_25814(reader);
}
});
...
var G__25959 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__25960 = s.append(c);
c = G__25959;
s = G__25960;
continue;
}
