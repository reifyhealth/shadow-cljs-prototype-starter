...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_27263 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_27263(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_27268 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_27268(reader);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27279 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_27279(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27284 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_27284(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27291 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_27291(reader);
}
});
...
var G__27393 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__27394 = s.append(c);
c = G__27393;
s = G__27394;
continue;
}
