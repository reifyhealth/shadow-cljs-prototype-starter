...
stickyOffsets:stickyOffsets,onHeaderRow:onHeaderRow,fixHeader:fixHeader},emptyNode=React.useMemo(function(){return hasData?null:"function"===typeof emptyText?emptyText():emptyText},[hasData,emptyText]),bodyTable=React.createElement(_Body.default,{data:mergedData,measureColumnWidth:fixHeader||horizonScroll||isSticky,expandedKeys:mergedExpandedKeys,rowExpandable:rowExpandable,getRowKey:getRowKey,onRow:onRow,emptyNode:emptyNode,childrenColumnName:mergedChildrenColumnName}),bodyColGroup=React.createElement(_ColGroup.default,
{colWidths:flattenColumns.map(function(_ref6){return _ref6.width}),columns:flattenColumns}),footerTable=summary&&React.createElement(_Footer.default,null,summary(mergedData)),customizeScrollBody=getComponent(["body"]);"function"===typeof customizeScrollBody&&hasData&&!fixHeader&&(0,_warning.default)(!1,"`components.body` with render props is only work on `scroll.y`.");if(fixHeader||isSticky){if("function"===typeof customizeScrollBody){var bodyContent=customizeScrollBody(mergedData,{scrollbarSize:scrollbarSize,
ref:scrollBodyRef,onScroll:onScroll});headerProps.colWidths=flattenColumns.map(function(_ref7,index){_ref7=_ref7.width;index=index===columns.length-1?_ref7-scrollbarSize:_ref7;if("number"===typeof index&&!Number.isNaN(index))return index;(0,_warning.default)(!1,"When use `components.body` with render props. Each column should have a fixed `width` value.");return 0})}else bodyContent=React.createElement("div",{style:(0,_objectSpread2.default)((0,_objectSpread2.default)({},scrollXStyle),scrollYStyle),
onScroll:onScroll,ref:scrollBodyRef,className:(0,_classnames.default)("".concat(prefixCls,"-body"))},React.createElement(TableComponent,{style:(0,_objectSpread2.default)((0,_objectSpread2.default)({},scrollTableStyle),{},{tableLayout:mergedTableLayout})},bodyColGroup,bodyTable,footerTable));var groupTableNode=React.createElement(React.Fragment,null,!1!==showHeader&&React.createElement(_FixedHeader.default,(0,_extends2.default)({noData:!mergedData.length},headerProps,columnContext,{direction:direction,
offsetHeader:offsetHeader,stickyClassName:stickyClassName,ref:scrollHeaderRef,onScroll:onScroll})),bodyContent,isSticky&&React.createElement(_stickyScrollBar.default,{ref:stickyRef,offsetScroll:offsetScroll,scrollBodyRef:scrollBodyRef,onScroll:onScroll,container:container}))}else groupTableNode=React.createElement("div",{style:(0,_objectSpread2.default)((0,_objectSpread2.default)({},scrollXStyle),scrollYStyle),className:(0,_classnames.default)("".concat(prefixCls,"-content")),onScroll:onScroll,ref:scrollBodyRef},
React.createElement(TableComponent,{style:(0,_objectSpread2.default)((0,_objectSpread2.default)({},scrollTableStyle),{},{tableLayout:mergedTableLayout})},bodyColGroup,!1!==showHeader&&React.createElement(_Header.default,(0,_extends2.default)({},headerProps,columnContext)),bodyTable,footerTable));var ariaProps=(0,_legacyUtil.getDataAndAriaProps)(props),fullTable=React.createElement("div",(0,_extends2.default)({className:(0,_classnames.default)(prefixCls,className,(_classNames={},(0,_defineProperty2.default)(_classNames,
"".concat(prefixCls,"-rtl"),"rtl"===direction),(0,_defineProperty2.default)(_classNames,"".concat(prefixCls,"-ping-left"),pingedLeft),(0,_defineProperty2.default)(_classNames,"".concat(prefixCls,"-ping-right"),pingedRight),(0,_defineProperty2.default)(_classNames,"".concat(prefixCls,"-layout-fixed"),"fixed"===tableLayout),(0,_defineProperty2.default)(_classNames,"".concat(prefixCls,"-fixed-header"),fixHeader),(0,_defineProperty2.default)(_classNames,"".concat(prefixCls,"-fixed-column"),fixColumn),
(0,_defineProperty2.default)(_classNames,"".concat(prefixCls,"-scroll-horizontal"),horizonScroll),(0,_defineProperty2.default)(_classNames,"".concat(prefixCls,"-has-fix-left"),flattenColumns[0]&&flattenColumns[0].fixed),(0,_defineProperty2.default)(_classNames,"".concat(prefixCls,"-has-fix-right"),flattenColumns[flattenColumns.length-1]&&"right"===flattenColumns[flattenColumns.length-1].fixed),_classNames)),style:style,id:id,ref:fullTableRef},ariaProps),React.createElement(MemoTableContent,{pingLeft:pingedLeft,
pingRight:pingedRight,props:(0,_objectSpread2.default)((0,_objectSpread2.default)({},props),{},{stickyOffsets:stickyOffsets,mergedExpandedKeys:mergedExpandedKeys})},title&&React.createElement(_Panel.default,{className:"".concat(prefixCls,"-title")},title(mergedData)),React.createElement("div",{className:"".concat(prefixCls,"-container")},groupTableNode),footer&&React.createElement(_Panel.default,{className:"".concat(prefixCls,"-footer")},footer(mergedData))));horizonScroll&&(fullTable=React.createElement(_rcResizeObserver.default,
{onResize:onFullTableResize},fullTable));var TableContextValue=React.useMemo(function(){return{prefixCls:prefixCls,getComponent:getComponent,scrollbarSize:scrollbarSize,direction:direction,fixedInfoList:flattenColumns.map(function(_,colIndex){return(0,_fixUtil.getCellFixedInfo)(colIndex,colIndex,flattenColumns,stickyOffsets,direction)}),isSticky:isSticky}},[prefixCls,getComponent,scrollbarSize,direction,flattenColumns,stickyOffsets,direction,isSticky]),BodyContextValue=React.useMemo(function(){return(0,
_objectSpread2.default)((0,_objectSpread2.default)({},columnContext),{},{tableLayout:mergedTableLayout,rowClassName:rowClassName,expandedRowClassName:expandedRowClassName,componentWidth:componentWidth,fixHeader:fixHeader,fixColumn:fixColumn,horizonScroll:horizonScroll,expandIcon:mergedExpandIcon,expandableType:expandableType,expandRowByClick:expandRowByClick,expandedRowRender:expandedRowRender,onTriggerExpand:onTriggerExpand,expandIconColumnIndex:expandIconColumnIndex,indentSize:indentSize})},[columnContext,
mergedTableLayout,rowClassName,expandedRowClassName,componentWidth,fixHeader,fixColumn,horizonScroll,mergedExpandIcon,expandableType,expandRowByClick,expandedRowRender,onTriggerExpand,expandIconColumnIndex,indentSize]),ResizeContextValue=React.useMemo(function(){return{onColumnResize:onColumnResize}},[onColumnResize]);return React.createElement(_TableContext.default.Provider,{value:TableContextValue},React.createElement(_BodyContext.default.Provider,{value:BodyContextValue},React.createElement(_ResizeContext.default.Provider,
{value:ResizeContextValue},fullTable)))}global=require("module$node_modules$$babel$runtime$helpers$interopRequireWildcard");module=require("module$node_modules$$babel$runtime$helpers$interopRequireDefault");Object.defineProperty(exports,"__esModule",{value:!0});exports.default=exports.INTERNAL_HOOKS=void 0;var _defineProperty2=module(require("module$node_modules$$babel$runtime$helpers$defineProperty")),_extends2=module(require("module$node_modules$$babel$runtime$helpers$extends")),_objectSpread2=
module(require("module$node_modules$$babel$runtime$helpers$objectSpread2")),_toConsumableArray2=module(require("module$node_modules$$babel$runtime$helpers$toConsumableArray")),_typeof2=module(require("module$node_modules$$babel$runtime$helpers$typeof")),_slicedToArray2=module(require("module$node_modules$$babel$runtime$helpers$slicedToArray")),React=global(require("module$node_modules$react$index")),_isVisible=module(require("module$node_modules$rc_util$lib$Dom$isVisible")),_classnames=module(require("module$node_modules$classnames$index")),
_shallowequal=module(require("module$node_modules$shallowequal$index")),_warning=module(require("module$node_modules$rc_util$lib$warning")),_rcResizeObserver=module(require("module$node_modules$rc_resize_observer$lib$index")),_getScrollBarSize=module(require("module$node_modules$rc_util$lib$getScrollBarSize")),_ColumnGroup=module(require("module$node_modules$rc_table$lib$sugar$ColumnGroup")),_Column=module(require("module$node_modules$rc_table$lib$sugar$Column")),_FixedHeader=module(require("module$node_modules$rc_table$lib$Header$FixedHeader")),
_Header=module(require("module$node_modules$rc_table$lib$Header$Header")),_TableContext=module(require("module$node_modules$rc_table$lib$context$TableContext")),_BodyContext=module(require("module$node_modules$rc_table$lib$context$BodyContext")),_Body=module(require("module$node_modules$rc_table$lib$Body$index")),_useColumns3=module(require("module$node_modules$rc_table$lib$hooks$useColumns")),_useFrame=require("module$node_modules$rc_table$lib$hooks$useFrame"),_valueUtil=require("module$node_modules$rc_table$lib$utils$valueUtil"),
_ResizeContext=module(require("module$node_modules$rc_table$lib$context$ResizeContext")),_useStickyOffsets=module(require("module$node_modules$rc_table$lib$hooks$useStickyOffsets")),_ColGroup=module(require("module$node_modules$rc_table$lib$ColGroup")),_legacyUtil=require("module$node_modules$rc_table$lib$utils$legacyUtil"),_Panel=module(require("module$node_modules$rc_table$lib$Panel$index")),_Footer=global(require("module$node_modules$rc_table$lib$Footer$index")),_expandUtil=require("module$node_modules$rc_table$lib$utils$expandUtil"),
_fixUtil=require("module$node_modules$rc_table$lib$utils$fixUtil"),_stickyScrollBar=module(require("module$node_modules$rc_table$lib$stickyScrollBar")),_useSticky2=module(require("module$node_modules$rc_table$lib$hooks$useSticky")),EMPTY_DATA=[],EMPTY_SCROLL_TARGET={};exports.INTERNAL_HOOKS="rc-table-internal-hook";var MemoTableContent=React.memo(function(_ref){return _ref.children},function(prev,next){return(0,_shallowequal.default)(prev.props,next.props)?prev.pingLeft!==next.pingLeft||prev.pingRight!==
next.pingRight:!1});Table.Column=_Column.default;Table.ColumnGroup=_ColumnGroup.default;Table.Summary=_Footer.FooterComponents;Table.defaultProps={rowKey:"key",prefixCls:"rc-table",emptyText:function(){return"No Data"}};exports.default=Table}
