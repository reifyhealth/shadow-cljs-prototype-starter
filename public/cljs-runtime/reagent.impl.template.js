...
var G__35824 = o;
(G__35824[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__35851__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__35851 = function (var_args){
var args = null;
...
while (G__35852__i < G__35852__a.length) {G__35852__a[G__35852__i] = arguments[G__35852__i + 0]; ++G__35852__i;}
  args = new cljs.core.IndexedSeq(G__35852__a,0,null);
} 
return G__35851__delegate.call(this,args);};
G__35851.cljs$lang$maxFixedArity = 0;
G__35851.cljs$lang$applyTo = (function (arglist__35853){
var args = cljs.core.seq(arglist__35853);
return G__35851__delegate(args);
});
...
var G__35825 = o;
(G__35825[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__35854__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__35855__i < G__35855__a.length) {G__35855__a[G__35855__i] = arguments[G__35855__i + 0]; ++G__35855__i;}
  args = new cljs.core.IndexedSeq(G__35855__a,0,null);
} 
return G__35854__delegate.call(this,args);};
G__35854.cljs$lang$maxFixedArity = 0;
G__35854.cljs$lang$applyTo = (function (arglist__35856){
var args = cljs.core.seq(arglist__35856);
return G__35854__delegate(args);
});
...
var G__35827 = props;
var G__35827__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35827,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__35827);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__35827__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__35828){
var map__35829 = p__35828;
var map__35829__$1 = cljs.core.__destructure_map(map__35829);
var props = map__35829__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35829__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__35830){
var map__35831 = p__35830;
var map__35831__$1 = cljs.core.__destructure_map(map__35831);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35831__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__35833 = jsprops;
(G__35833["defaultValue"] = value);

(G__35833["onChange"] = (function (p1__35832_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__35832_SHARP_);
}));
...
var vec__35835 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35835,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35835,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35835,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___35858 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___35858 == null)){
} else {
var key_35859 = temp__5739__auto___35858;
(jsprops["key"] = key_35859);
}
...
var temp__5739__auto___35862 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___35862 == null)){
} else {
var key_35863 = temp__5739__auto___35862;
reagent.impl.template.oset(jsprops,"key",key_35863);
}
...
var G__35839 = reagent.impl.template.__GT_NativeWrapper();
(G__35839["name"] = c);
...
var G__35840 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__35840) : reagent.impl.template.as_element.call(null,G__35840));
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq35843){
var G__35844 = cljs.core.first(seq35843);
var seq35843__$1 = cljs.core.next(seq35843);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35844,seq35843__$1);
}));
...
break;
default:
var G__35877 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__35877;
continue;
...
var n__4648__auto___35878 = a.length;
var i_35879 = (0);
while(true){
if((i_35879 < n__4648__auto___35878)){
(a[i_35879] = reagent.impl.template.as_element((a[i_35879])));

var G__35880 = (i_35879 + (1));
i_35879 = G__35880;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4648__auto___35881 = a.length;
var i_35883 = (0);
while(true){
if((i_35883 < n__4648__auto___35881)){
var val_35884 = (a[i_35883]);
if(((cljs.core.vector_QMARK_(val_35884)) && ((reagent.impl.template.key_from_vec(val_35884) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_35883] = reagent.impl.template.as_element(val_35884));

var G__35885 = (i_35883 + (1));
i_35883 = G__35885;
continue;
} else {
}
...
var ctx = ({});
var vec__35847 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35847,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35847,(1),null);
...
var G__35850 = (cljs.core.count(argv) - first_child);
switch (G__35850) {
case (0):
